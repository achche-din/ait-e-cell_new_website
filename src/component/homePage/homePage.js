	...
	return (
        ...
        <div className="mainDiv2">
          <div className="cards1">
              ...
              <h1>Udyamita</h1>
                ...
                <div style={{margin:"1%"}}><p>We the Innovation and entrepreneurship cell of Army Institute Of Technology are delighted to present our very first newsletter "Udyamita"</p></div>
                
                <p style={{lineHeight:"2em"}}>A brilliant notion requires careful refining to become a reality. I&E-Cell of AIT Pune is pleased to deliver one of its kind STARTUP SAGA - A BUG IN A STARTUP.
                   Startup Saga - A bug in a start-up in which we will provide you a specific range of problem statements faced by startups and decide the better innovation towards it.</p>
           <div style={{margin:"2%"}}> <p>The E-Cell (Entrepreneurship Cell) aims to promote the entrepreneurship culture in and around the campus by providing multiple platforms to budding entrepreneurs where they can improve upon their business models, get mentorship by successful entrepreneurs, interact with investors and groom their entrepreneurship skills.</p></div>
         
          <div className="container">
         
          <p>This newsletter includes all event details occurred in e-cell this year (session 2020-2021) .<br/>
            It's a record of the wonderful things the E-Cell has been able to achieve with the cooperation of the esteemed faculty and students of our college. We hope that this record may serve to inspire a flame of entrepreneurship that becomes a blazing crescendo of innovation, out of the box thinking and entrepreneurship
           </p>
          </div>
           <button style={{margin:"1em"}} className="dwnBtn">download</button>
          </div>
          <div className="cards2" >
             <img  style={{height:"100%" , width:"100%" , borderRadius:"2%"}} src="https://aitecell.in/assets/img/newletter_image.png" alt="balckHat"/>
          </div>
        </div>
        ...
        <div className="mainDivAbt">
           <div className="hadding">
               <h2> Learn More <span style={{color:"blue", }}>About Us</span></h2>  
           </div>
           <div className="section">
               <div className="vision">
                      ...
                      <div style={{padding:"10px;"}}>
                        <span>To be an important part of Government 's dream of 5 trillion economy, by contributing through startups of AIT students.</span>
                      </div>
               </div>
               <div className="mission">
                   ...
                   <div style={{padding:"10px;"}}>
                     <span>To build an ecosystem to identify, nurture innovation and entrepreneurship skills amongst students and to generate successful commercial enterprise contributing towards significant job creations.</span>
                   </div>
               </div>
           </div>
        </div>
        ...
        <div className="vedioDiv">
            <div className="twoDiv">
              ...
              <iframe className="vedioCard" src="https://www.youtube.com/embed/vf0EG3_EGLo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              <iframe className="vedioCard" src="https://www.youtube.com/embed/vf0EG3_EGLo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
-- Albert Schweitzer.</p>
       ...
       <div className="pastEventContainer">
          <div className="headingPastEvent">
              ...
              <p>“Build your own dreams, or someone else will hire you to build theirs.”
-- Farrah Gray</p>
